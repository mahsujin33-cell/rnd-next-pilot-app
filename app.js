(function () {
  ...
  async function exportHwpReport(id) {
    ...
    try {
      ...
      link.remove();
      URL.revokeObjectURL(url);
      showToast("Kordoc HWPX 보고서를 다운로드했습니다.");
    } catch (error) {
